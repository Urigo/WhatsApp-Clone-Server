...
import { IChatModuleContext } from "../modules/chat/index";
...
export namespace QueryResolvers {
  export interface Resolvers<Context = IChatModuleContext, TypeParent = {}> {
...
export namespace UserResolvers {
  export interface Resolvers<Context = IChatModuleContext, TypeParent = User> {
...
export interface IResolvers<Context = IChatModuleContext> {
