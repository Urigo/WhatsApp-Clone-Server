...
import { IAuthModuleContext } from "../modules/auth/index";
...
export namespace QueryResolvers {
  export interface Resolvers<Context = IAuthModuleContext, TypeParent = {}> {
...
export namespace UserResolvers {
  export interface Resolvers<Context = IAuthModuleContext, TypeParent = User> {
...
export namespace ChatResolvers {
  export interface Resolvers<Context = IAuthModuleContext, TypeParent = Chat> {
    id?: IdResolver<string, TypeParent, Context>;
...
export interface IResolvers<Context = IAuthModuleContext> {
