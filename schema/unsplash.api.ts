...
export class UnsplashApi extends RESTDataSource {
  ...
  willSendRequest(request: RequestOptions) {
    request.headers.set('Authorization', 'Client-ID 4d048cfb4383b407eff92e4a2a5ec36c0a866be85e64caafa588c110efad350d')
  }

  async getRandomPhoto() {
    const trackedRandomPhoto = await trackProvider(({query, orientation}: RandomPhotoInput) =>
