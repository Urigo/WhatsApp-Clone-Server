...
@@ -14,6 +18,10 @@
 ...
 ┊16┊20┊    "@types/node": "^11.9.5",
+┊  ┊21┊    "concurrently": "^4.1.0",
+┊  ┊22┊    "graphql-codegen-typescript-common": "^0.17.0",
+┊  ┊23┊    "graphql-codegen-typescript-resolvers": "^0.17.0",
+┊  ┊24┊    "graphql-codegen-typescript-server": "^0.17.0",
 ┊17┊25┊    "nodemon": "^1.18.10",
 ┊18┊26┊    "ts-node": "^8.0.2",
 ┊19┊27┊    "typescript": "^3.3.3333"
```
```diff
@@ -24,6 +32,7 @@
 ┊24┊32┊    "cors": "^2.8.5",
...
+┊  ┊35┊    "graphql-code-generator": "^0.17.0",
