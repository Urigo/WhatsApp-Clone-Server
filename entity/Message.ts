...
export class Message {
  ...
  @OneToMany(type => Recipient, recipient => recipient.message, {cascadeInsert: true, cascadeUpdate: true, eager: true})
  recipients: Recipient[];

  @ManyToMany(type => User, user => user.holderMessages, {cascadeInsert: true, cascadeUpdate: true, eager: true})
  @JoinTable()
  holders: User[];
